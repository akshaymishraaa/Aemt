import { personalData, studentAdmissionDetails } from "../constants/addStudent/AddStudentModal";
...
const intialState = {
    ...
    formsSubmisionSteps: [
        ...
        { name: 'previousAcademicDetails', stepNo: 2, submited: null, validate: null, values: null },
