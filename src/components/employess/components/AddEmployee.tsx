                        ...
                        return <Form>
                            <div className='row'>
                                <div className='col-6'>
                                    ...
                                    <label htmlFor="firstName">Pan number:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="panNo"
                                    ...
                                    <label htmlFor="firstName">Email Id:<span className="text-danger">*</span></label>
                                    <div>
                                        <Field
                                            id="email"
                                            name="email"
                                    ...
                                    <label htmlFor="firstName">Phone number:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="phone"
                                    ...
                                    <label htmlFor="firstName">Permanent Address:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="permanentAddress"
                                    ...
                                    <label htmlFor="firstName">Local Address:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="localAddress"
                                    ...
                                    <label htmlFor="firstName">Joining date:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="joiningData"
                                    ...
                                    <label htmlFor="firstName">Employeement Type:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="employeementType"
                                    ...
                                    <label htmlFor="firstName">Department:<span className="text-danger">*</span></label>
                                    <div>
                                        {/* <span> <LockResetIcon/></span> */}
                                        <Field
                                            id="department"
